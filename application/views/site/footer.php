			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="bank">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 no-padding">
				    <div class="footer-info">            
				      ...
				      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				        <a href="" title=""><strong>DÀNH CHO NGƯỜI KHÁCH HÀNG</strong></a>
				          <li> <a href="#" title="">Bảo vệ khách hàng</a></li>
				          <li> <a href="#" title="">Quy định đối với khách hàng</a></li>
				          <li> <a href="#" title="">Câu hỏi thường gặp</a></li>
				          <li> <a href="#" title="">Hưỡng dẫn mua,thuê Online</a></li> 
				           
				      </div>
				      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				        <a href="" title=""><strong>DÀNH CHO NGƯỜI BÁN</strong></a>                
				          <li> <a href="#" title="">Mở shop trên Shoppe</a></li> 
		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>FASHION TNT</strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span>Địa chỉ: Phú Diễn, Bắc Từ Liêm, Hà Nội<br>
