<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""><a href="<?php echo base_url('product/news'); ?>" class='product_title'>SẢN PHẨM MỚI NHẤT </a><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""></h3>
	  </div>
			...
			<?php foreach ($new_product as $value) {
				...
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
		  			<div class="product_item">
						...
						<a href="<?php echo base_url('cart/add/'.$value->id); ?>"><button class='btn btn-info'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Thêm vào giỏ hàng</button></a>
		  			</div>
				</div>
			<?php } ?>	
	  	</div>
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('ban-chay'); ?>" class='product_title'>HOT</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('product/views'); ?>" class='product_title'>VIEWS</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
